var sparklines = function sparklines ( selector /*, aspectRatio */ ) {
    ...
    for ( var i = 0; i < els.length; i++ ) {
        ...
        svg.setAttribute( 'style', 'padding:' + strokeWidth / 2 + 'px' );
        ...
        if ( filled ) {
            pathString += ' V ' + maxHeight;
            pathString += ' L 0 ' + maxHeight + ' Z';
            e = document.createElementNS( namespaceURI, 'path' );
            e.setAttribute( 'd', pathString );
